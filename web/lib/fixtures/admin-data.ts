...
export const adminInquiries: AdminInquiry[] = [
  ...
  },
  {
    id: "i-006",
    venueSlug: "salle-al-andalous",
    userName: "Imane Alaoui",
    userEmail: "imane.a@exemple.be",
    userPhone: "+32 478 55 66 77",
    inquiryType: "single_day",
    datePrimary: "2026-08-22",
    guestsPrimary: 320,
    dayLabeling: "neutral",
    message: "Juste le jour du henné, 320 personnes. Possible de commencer à 17h ?",
    status: "pending",
  ...
  },
  {
    id: "i-007",
    venueSlug: "salle-al-andalous",
    userName: "Yousra Bel Haj",
    userEmail: "yousra.bh@exemple.be",
    userPhone: "+32 479 66 77 88",
    inquiryType: "two_day",
    datePrimary: "2026-10-10",
    dateSecondary: "2026-10-11",
    guestsPrimary: 220,
    guestsSecondary: 380,
    dayLabeling: "men_women",
    message: "",
    status: "accepted",
    venueResponse: "Avec plaisir, les deux dates sont ouvertes. On vous envoie le devis d'ici ce soir.",
    createdAt: "2026-04-14T10:00:00Z",
  },
  {
    id: "i-008",
    venueSlug: "salle-al-andalous",
    userName: "Soukaina Ziani",
    userEmail: "soukaina.z@exemple.be",
    userPhone: "+32 476 11 22 33",
    inquiryType: "single_day",
    datePrimary: "2026-06-06",
    guestsPrimary: 650,
    dayLabeling: "neutral",
    message: "650 invités, possibilité ?",
    status: "declined",
    venueResponse: "Désolé, 650 dépasse notre capacité maximale (600). Nous pouvons accueillir jusqu'à 600.",
